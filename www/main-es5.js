...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | products-by-category-products-by-category-module */
        "products-by-category-products-by-category-module").then(__webpack_require__.bind(null,
        /*! ./products-by-category/products-by-category.module */
        "./src/app/products-by-category/products-by-category.module.ts")).then(function (m) {
          return m.ProductsByCategoryPageModule;
        });
      }
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _cart_cart_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./cart/cart.page */
    "./src/app/cart/cart.page.ts");
    /* harmony import */


    var _link_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./link.service */
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, navController, storage, eventsService, httpClient, modalController, linkService, loadingController, oneSignal) {
        var _this = this;
        ...
        this.httpClient.get(this.linkService.getAPILink() + this.products_categories_link + '?consumer_key=' + this.linkService.getConsumerKey() + '&consumer_secret=' + this.linkService.getConsumerSecret()).subscribe(function (data) {
          ...
          for (var _i = 0; _i < temp.length; _i++) {
            for (var j = 0; j < _this.categories.length; j++) {
              ...
              if (_this.categories[j].id == temp[_i].parent) {
                _this.categories[j].subCategories.push(temp[_i]);
              }
            }
          }
        }, function (err) {
        ...
        this.eventsService.getObservable().subscribe(function (data) {
          if (data == "updateMenu") {
      ...
      _createClass(AppComponent, [{
        ...
        value: function setupPush() {
          ...
          this.oneSignal.handleNotificationReceived().subscribe(function (data) {}); // Notification was really clicked/opened
        ...
        value: function ngOnInit() {
          ...
          this.storage.ready().then(function () {
            _this4.storage.get("userLoginInfo").then(function (userLoginInfo) {
              if (userLoginInfo != null) {
                console.log("User logged in...");
                _this4.user = userLoginInfo.user;
        ...
        value: function openCategoryPage(category) {
        ...
        key: "openPage",
        value: function openPage(pageName) {
          var _this5 = this;
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"], _events_service__WEBPACK_IMPORTED_MODULE_6__["EventsService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _link_service__WEBPACK_IMPORTED_MODULE_9__["LinkService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_10__["OneSignal"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _cart_cart_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./cart/cart.module */
    "./src/app/cart/cart.module.ts");
    /* harmony import */


    var _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_9__["IonicStorageModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"], _cart_cart_module__WEBPACK_IMPORTED_MODULE_11__["CartPageModule"]],
      providers: [_ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_13__["OneSignal"], _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_12__["PayPal"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], {
  ...
  function srcAppCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(navController, storage, modalController, toastController) {
        var _this6 = this;
        ...
        this.total = 0.0;
        this.storage.ready().then(function () {
          _this6.storage.get("cart").then(function (data) {
            if (data == null) {
              _this6.showEmptyCartMessage = true;
              return;
            }

            _this6.cartItems = data;
            console.log(_this6.cartItems);

            if (_this6.cartItems.length > 0) {
              _this6.cartItems.forEach(function (item, index) {
                if (item.variation) {
                  _this6.total = _this6.total + parseFloat(item.variation.price) * item.qty;
                } else {
                  _this6.total = _this6.total + item.product.price * item.qty;
                }
              });
            } else {
              _this6.showEmptyCartMessage = true;
      ...
      _createClass(CartPage, [{
        key: "removeFromCart",
        value: function removeFromCart(item, i) {
          var _this7 = this;
          ...
          this.storage.set("cart", this.cartItems).then(function () {
            _this7.total = _this7.total - price * qty;
          });
        ...
        value: function checkout() {
          ...
          this.storage.get("userLoginInfo").then(function (data) {
            if (data != null) {
              _this8.modalController.dismiss().then(function () {
                _this8.navController.navigateForward('checkout');
              });
            } else {
              var navigationExtras = {
                state: {
              ...
              _this8.navController.navigateForward('Login', navigationExtras);
            }
          });
        }
      }, {
        key: "changeQty",
        value: function changeQty(item, i, change) {
          var _this9 = this;

          var price;
          if (!item.variation) price = item.product.price;else price = parseFloat(item.variation.price);
          var qty = item.qty;
          ...
          this.storage.set("cart", this.cartItems).then(function () {
            _this9.presentToast("Cart Updated.");
          });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"]])], CartPage);
    /***/
  },
  ...
  /***/
  function srcAppLinkServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    LinkService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], LinkService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\osian\Desktop\codecanyon-19128672-ionic-2-app-for-woocommerce\cc106appdev-master\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
